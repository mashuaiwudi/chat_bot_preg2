...
def model_opts(parser):
    ...
    group.add('--encoder_type', '-encoder_type', type=str, default='brnn',#rnn
    ...
    group.add('--enc_rnn_size', '-enc_rnn_size', type=int, default=300,#500
              help="""Size of encoder rnn hidden states.
                       Must be equal to dec_rnn_size except for
                       speech-to-text.""")
    group.add('--dec_rnn_size', '-dec_rnn_size', type=int, default=300,#500
    ...
    '''
    group.add('--global_attention', '-global_attention',
              type=str, default='mlp', choices=['dot', 'general', 'mlp'],
              help="""The attention type to use:
                           dotprod or general (Luong) or MLP (Bahdanau)""")
...
def train_opts(parser):
    ...
    group.add('--learning_rate', '-learning_rate', type=float, default=0.15,#1.0
